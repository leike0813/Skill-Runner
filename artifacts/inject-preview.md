...
- engine: `codex`
- execution_mode: `auto`
- run_dir: `/tmp/skill_patch_preview_literature-analysis_4fqir75a`
- snapshot_skill_md: `/tmp/skill_patch_preview_literature-analysis_4fqir75a/.codex/skills/literature-analysis/SKILL.md`
---
...
- digest (digest_path) -> prefer writing the final deliverable under `/tmp/skill_patch_preview_literature-analysis_4fqir75a/artifacts/` (nested folders allowed)
- references (references_path) -> prefer writing the final deliverable under `/tmp/skill_patch_preview_literature-analysis_4fqir75a/artifacts/` (nested folders allowed)
- citation-analysis (citation_analysis_path) -> prefer writing the final deliverable under `/tmp/skill_patch_preview_literature-analysis_4fqir75a/artifacts/` (nested folders allowed)
- citation-analysis-report (citation_analysis_report_path) -> prefer writing the final deliverable under `/tmp/skill_patch_preview_literature-analysis_4fqir75a/artifacts/` (nested folders allowed)
