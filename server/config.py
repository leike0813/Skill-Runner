...
_C.SYSTEM.LOCAL_RUNTIME_LEASE_TTL_SEC = int(
    os.environ.get("SKILL_RUNNER_LOCAL_RUNTIME_LEASE_TTL_SEC", "60")
)
_C.SYSTEM.LOCAL_RUNTIME_LEASE_SWEEP_INTERVAL_SEC = int(
    os.environ.get("SKILL_RUNNER_LOCAL_RUNTIME_LEASE_SWEEP_INTERVAL_SEC", "5")
)
_C.SYSTEM.LOCAL_RUNTIME_LEASE_FIRST_HEARTBEAT_GRACE_SEC = int(
    os.environ.get("SKILL_RUNNER_LOCAL_RUNTIME_LEASE_FIRST_HEARTBEAT_GRACE_SEC", "15")
)
...
_C.SYSTEM.RUNTIME_ENV = CN()
_C.SYSTEM.RUNTIME_ENV.FORCED = CN()
_C.SYSTEM.RUNTIME_ENV.FORCED.OPENCODE_ENABLE_EXA = "1"

_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE = CN()
_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE.ENABLED = _env_bool(
    "SKILL_RUNNER_ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE_ENABLED",
    True,
)
_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE.SOURCE_REPOSITORY = os.environ.get(
    "SKILL_RUNNER_ZOTERO_BRIDGE_BUNDLE_SOURCE_REPOSITORY",
    "https://github.com/leike0813/zotero-agents",
)
_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE.SOURCE_BRANCH = os.environ.get(
    "SKILL_RUNNER_ZOTERO_BRIDGE_BUNDLE_SOURCE_BRANCH",
    "host-bridge/zotero-bridge-cli-bundle",
)
_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE.INTERVAL_SEC = int(
    os.environ.get("SKILL_RUNNER_ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE_INTERVAL_SEC", "86400")
)
_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE.STARTUP_DELAY_SEC = int(
    os.environ.get("SKILL_RUNNER_ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE_STARTUP_DELAY_SEC", "30")
)
_C.SYSTEM.ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE.TIMEOUT_SEC = int(
    os.environ.get("SKILL_RUNNER_ZOTERO_BRIDGE_BUNDLE_AUTO_UPDATE_TIMEOUT_SEC", "30")
)
