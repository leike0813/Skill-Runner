...
from ..engines.common.callbacks.openai_local_callback_server import openai_local_callback_server
from ..engines.codex.auth import CodexOAuthProxyFlow, CodexOAuthProxySession
from ..engines.codex.auth.runtime_handler import CodexAuthRuntimeHandler
from ..engines.gemini.auth import (
    GeminiAuthCliFlow,
    GeminiAuthCliSession,
    GeminiOAuthProxyFlow,
    GeminiOAuthProxySession,
)
from ..engines.gemini.auth.runtime_handler import GeminiAuthRuntimeHandler
from ..engines.gemini.auth.callbacks.local_callback_server import gemini_local_callback_server
from ..engines.iflow.auth import (
    IFlowAuthCliFlow,
    IFlowAuthCliSession,
    IFlowOAuthProxyFlow,
    IFlowOAuthProxySession,
)
from ..engines.iflow.auth.runtime_handler import IFlowAuthRuntimeHandler
from ..engines.iflow.auth.callbacks.local_callback_server import iflow_local_callback_server
from ..engines.opencode.auth import (
    OpencodeAuthCliFlow,
...
from ..engines.opencode.auth.runtime_handler import OpencodeAuthRuntimeHandler
from ..engines.opencode.auth.callbacks.antigravity_local_callback_server import (
    antigravity_local_callback_server,
)
from ..engines.common.openai_auth import (
    OpenAIDeviceProxyFlow,
    OpenAIDeviceProxySession,
    OpenAIOAuthError,
    OpenAITokenSet,
)
from ..runtime.auth.callbacks import CallbackListenerRegistry, CallbackStateStore
from ..runtime.auth.driver_registry import AuthDriverRegistry
from ..runtime.auth.log_writer import AuthLogWriter, TransportLogPaths
from ..runtime.auth.session_lifecycle import (
...
from ..runtime.auth.session_store import AuthSessionStore, SessionPointer
...
class EngineAuthFlowManager:
    def __init__(
        ...
        self._callback_listener_registry = CallbackListenerRegistry()
        self._callback_listener_registry.register(channel="openai", listener=openai_local_callback_server)
        self._callback_listener_registry.register(channel="gemini", listener=gemini_local_callback_server)
        self._callback_listener_registry.register(channel="iflow", listener=iflow_local_callback_server)
        self._callback_listener_registry.register(
            channel="antigravity",
            listener=antigravity_local_callback_server,
        )
        self._engine_auth_handlers = {
            "codex": CodexAuthRuntimeHandler(self),
            "gemini": GeminiAuthRuntimeHandler(self),
            "iflow": IFlowAuthRuntimeHandler(self),
            "opencode": OpencodeAuthRuntimeHandler(self),
        }
