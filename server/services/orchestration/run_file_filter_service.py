...
ALLOWLIST_NON_DEBUG_PATH = (
    Path(__file__).resolve().parents[2] / "assets" / "configs" / "run_bundle_allowlist_non_debug.ignore"
)
DENYLIST_DEBUG_PATH = (
    Path(__file__).resolve().parents[2] / "assets" / "configs" / "run_bundle_denylist_debug.ignore"
)
