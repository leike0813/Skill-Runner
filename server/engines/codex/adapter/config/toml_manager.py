...
class CodexConfigManager:
    ...
    _DEFAULT_CONFIG_PATH = Path(__file__).resolve().parents[4] / "assets" / "configs" / "codex" / "default.toml"
    _ENFORCED_CONFIG_PATH = Path(__file__).resolve().parents[4] / "assets" / "configs" / "codex" / "enforced.toml"
