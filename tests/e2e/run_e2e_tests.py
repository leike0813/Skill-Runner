...
def _ensure_cli_available(engine: str) -> None:
    cmd = {"codex": "codex", "gemini": "gemini", "opencode": "opencode", "qwen": "qwen"}[engine]
...
async def main() -> int:
    ...
    parser.add_argument("-e", "--engine", help="Override execution engine (codex/gemini/opencode/qwen)", default=None)
