...
def _isolate_persistence_root(tmp_path):
    ...
    old_temp_skill_package_cache_ttl_days = config.SYSTEM.TEMP_SKILL_PACKAGE_CACHE_TTL_DAYS
    ...
    config.SYSTEM.TEMP_SKILL_PACKAGE_CACHE_TTL_DAYS = 30
    ...
    try:
        ...
        config.SYSTEM.TEMP_SKILL_PACKAGE_CACHE_TTL_DAYS = old_temp_skill_package_cache_ttl_days
