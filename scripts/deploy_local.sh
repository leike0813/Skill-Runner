...
export ZOTERO_BRIDGE_BIN="${ZOTERO_BRIDGE_BIN:-$SKILL_RUNNER_NPM_PREFIX/bin/zotero-bridge}"
...
export SKILL_RUNNER_LOCAL_BIND_HOST="${SKILL_RUNNER_LOCAL_BIND_HOST:-0.0.0.0}"
