...
##### [GitLab API 工具（可选，但强烈推荐）](#gitlab-api-工具可选但强烈推荐)
...
##### [常用 Helicone 请求头](#常用-helicone-请求头)
...
*   **apiKey**：使用 `env` 变量语法设置，[了解更多](about:/docs/config#env-vars)。
