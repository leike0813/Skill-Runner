...
[Function Calling](about:/api/docs/guides/function-calling#function-calling-with-structured-outputs)
...
* Outputs valid JSON
  ...
  * JSON Mode: Yes
* Adheres to schema
  * Structured Outputs: Yes (see supported schemas)
  * JSON Mode: No
* Compatible models
  * Structured Outputs: gpt-4o-mini, gpt-4o-2024-08-06, and later
  * JSON Mode: gpt-3.5-turbo, gpt-4-* and gpt-4o-* models
* Enabling
