...
- [x] Implement live streaming parser
- [x] Add `stream_event` incremental parsing
- [x] Add `tool_call` / MCP process-event extraction
- [x] Introduce richer qwen-specific auth detection patterns if needed
